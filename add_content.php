...
<section class="video-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>video Recorded Classes <span>*</span></p>
      <select name="playlist" class="box" required>
         <option value="" disabled selected>--select Recorded Classes</option>
         <?php
         ...
         <?php
            ...
            echo '<option value="" disabled>no Recorded Class created yet!</option>';
         }
         ?>
      </select>
