...
<!-- Recorded Classes section starts  -->

<section class="playlist">

   <h1 class="heading">Recorded Classes details</h1>
   ...
   <div class="row">
      ...
      <div class="col">
         <form action="" method="post" class="save-list">
            ...
            ?>
               <button type="submit" name="save_list"><i class="far fa-bookmark"></i><span>save Recorded Class</span></button>
            <?php
               }
            ?>
         </form>
      ...
      <?php
            ...
            echo '<p class="empty">this Recorded Class was not found!</p>';
         }  
      ?>
...
<section class="videos-container">
   ...
   <h1 class="heading">Recorded Classes videos</h1>
